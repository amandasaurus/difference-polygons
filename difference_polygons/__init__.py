...
def do_difference(filename_a, files_to_remove, output_filename, min_area, quiet=False):
    if not quiet:
...
def main(argv=None):
    ...
    do_difference(args.land, args.remove, args.output, args.min_area, args.quiet)
